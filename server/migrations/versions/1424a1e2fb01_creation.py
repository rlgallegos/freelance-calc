...
Revision ID: 1424a1e2fb01
Revises: 
Create Date: 2023-04-15 18:46:17.984980
...
def upgrade():
    ...
    sa.Column('category4', sa.Integer(), nullable=True),
    sa.Column('category5', sa.Integer(), nullable=True),
